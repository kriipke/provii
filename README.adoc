...
The script itself is hosted at link:https://raw.github.com/kriipke/provii/master/provii[]. Additionally, the list of installers available via `provii` can be found at link:https://github.com/kriipke/provii/tree/master/installs[here] (or listed using `provii` itself, see <<provii ls,`provii ls`>>)
...
[source,bash]
bash -c "$( curl https://raw.github.com/kriipke/provii/master/provii )" fd
